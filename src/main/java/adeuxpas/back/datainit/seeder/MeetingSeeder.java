...
public class MeetingSeeder {
        ...
        public void seedMeetings() {
                ...
                sixteenthMeeting
                                .setSellerAdditionalInfo(
                                                "Bravo pour avoir choisi ce magnifique objet, vous avez beaucoup de goût :)");
                ...
                seventeenthMeeting.setSellerAdditionalInfo(
                                "Pouvez-vous confirmer la compatibilité avec mon équipement ?");
                ...
                eighteenthMeeting
                                .setBuyerAdditionalInfo("J'aimerais avoir la possibilité d'un retour sous conditions.");
