...
public class AdSeeder {
    ...
    public List<Ad> createAds(List<User> users) {
        ...
        eleventhAd.setArticleDescription(
                "Ces balles anti-stress chinoises, ornées de motifs traditionnels, sont parfaites pour réduire le stress et améliorer la concentration. Leur douce sonorité et texture agréable offrent une expérience relaxante. En excellent état, elles sont idéales pour la détente au quotidien.");
        eleventhAd.setCreationDate(LocalDateTime.now().plusMinutes(4));
        eleventhAd.setPrice(BigDecimal.valueOf(8));
        eleventhAd.setTitle("Balles anti-stress chinoises");
        ...
        fifteenthAd.setTitle("Casquette Marlboro");
        ...
        seventeenthAd.setArticleDescription("Je le vends parce qu'il est trop petit pour mon poignet");
        seventeenthAd.setCreationDate(LocalDateTime.now().plusMinutes(5));
        seventeenthAd.setPrice(BigDecimal.valueOf(39));
        seventeenthAd.setTitle("Bracelet cactus");
        ...
        eighteenthAd.setArticleDescription("Dessous de verre blanc Walter");
        eighteenthAd.setCreationDate(LocalDateTime.now().plusMinutes(5));
        eighteenthAd.setPrice(BigDecimal.valueOf(4.99));
        eighteenthAd.setTitle("Dessous de verre en liège Heisenberg");
        ...
        allAds.addAll(firstUserAds);
        allAds.addAll(secondUserAds);
        allAds.addAll(thirdUserAds);
        allAds.addAll(fourthUserAds);
        allAds.addAll(fifthUserAds);
