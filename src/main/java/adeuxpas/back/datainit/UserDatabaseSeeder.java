...
public class UserDatabaseSeeder {
     ...
     * @param passwordEncoder             The password encoder used to encode user
    ...
    /**
     * Fetches addresses from the data.gouv.fr api and returns them as a list of
     * PreferredMeetingPlace objects.
     * 
        ...
        try {
            ...
            if (responsecode != 200) {
                ...
                for (JsonNode address : addresses) {
                    ...
                    PreferredMeetingPlace preferredMeetingPlace = new PreferredMeetingPlace(name, street, city,
                            postalCode, user);
