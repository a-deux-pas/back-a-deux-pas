 ...
 *
 * <p>
 * This controller provides endpoints for managing ads, including retrieving lists of ads,
...
public class AdController {
     ...
     *
     * <p>This endpoint fetches a paginated list of ads from the AdService based on the provided filters.
     * The filters include price ranges, cities and postal codes, article states, and category.
     * If successful, it returns a ResponseEntity containing the paginated list of ads.
     * If an unexpected exception occurs during the operation, it returns a 500 Internal Server Error response
     * with an error message in the response body.</p>
     *
     * @param priceRangesFilter         the list of price ranges to filter ads by
     * @param citiesAndPostalCodesFilter the list of cities and postal codes to filter ads by
     ...
     *
     * @see AdService#findFilteredAdHomeResponseDTOs(List, List, List, String, Pageable)
     */
    ...
    public ResponseEntity<Object> getAdsPage(
       ...
       try {
            ...
            Page<AdHomeResponseDTO> adsPage = this.adService.findFilteredAdHomeResponseDTOs(priceRangesFilter, citiesAndPostalCodesFilter,
