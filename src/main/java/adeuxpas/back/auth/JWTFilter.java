...
public class JWTFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if (authorizationHeader != null) {
            ...
            // // Extract the sub (email) from the token, load its user details and pass
            // them to a Spring Security UserDetails object
        ...
        // // Hand over control to the next filter in the chain, or to the Servlet if
