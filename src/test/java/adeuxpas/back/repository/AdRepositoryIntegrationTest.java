 ...
 * <p>
 * These tests ensure that the repository methods interact correctly with the underlying database,
 * and that the custom queries return the expected results based on various filter criteria.
 * </p>
 * <p>
 * The tests use a remote Docker-managed MySQL container (@Testcontainers) for database interactions, and the database is seeded
 * with test data before each test method is executed.
 * </p>
 * <p>
 * Test methods cover different scenarios of filtering ads based on postal codes, article states,
...
class AdRepositoryIntegrationTest {
    ...
    /**
     * Static MySQLContainer instance for running a MySQL database in a Docker container.
     */
    @Container
    @ServiceConnection
    ...
    /**
     * Test method to verify that the database connection is established successfully.
     */
    @Test
    ...
    /**
     * This method tests the {@link AdRepository#findByAcceptedStatusesFilteredOrderedByCreationDateDesc(List, List, BigDecimal, BigDecimal, BigDecimal, BigDecimal, BigDecimal, BigDecimal, BigDecimal, BigDecimal, BigDecimal, BigDecimal, String, String, String, List, List, Pageable)}
    ...
    /**
     * This method tests the {@link AdRepository#findByAcceptedStatusesOrderedByCreationDateDesc(List, List, Pageable)}
