...
// For the existing tests to run correctly, please :
// - do not create any more ads, these should suffice for any future test
// - do not modify the already created objects' properties' values
// (but new properties can be safely added, along with their respective values)
